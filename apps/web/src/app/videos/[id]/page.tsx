...
export default async function VideoPage({ params }: VideoPageProps) {
  ...
  try {
    ...
    // Fetch related videos from same band
    if (video.band) {
            ...
            <div className="mt-6">
              ...
              {video.band && (
                <Link
                  ...
                  className="inline-flex items-center gap-3 p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors group mb-6"
                >
                  {video.band.logoUrl && (
                    <img
