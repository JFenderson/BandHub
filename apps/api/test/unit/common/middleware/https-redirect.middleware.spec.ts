...
describe('HttpsRedirectMiddleware', () => {
  ...
  describe('Production Environment', () => {
    ...
    it('should redirect HTTP to HTTPS with 301 status', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(301, 'https://hbcubandhub.tech/api/bands');
    ...
    it('should preserve URL path and query parameters', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(
        301,
        'https://hbcubandhub.tech/api/bands?name=test&limit=10'
      );
      expect(mockNext).not.toHaveBeenCalled();
    });
    ...
    it('should preserve complex query strings', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(
        301,
        'https://api.hbcubandhub.tech/api/videos?category=performance&sort=date&order=desc'
      );
      expect(mockNext).not.toHaveBeenCalled();
    });
    ...
    it('should handle requests with port numbers', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(301, 'https://hbcubandhub.tech:8080/api/bands');
      expect(mockNext).not.toHaveBeenCalled();
    });
    ...
    it('should use originalUrl when available', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(301, 'https://hbcubandhub.tech/api/bands?full=true');
      expect(mockNext).not.toHaveBeenCalled();
    });
    ...
    it('should allow subdomains of allowed hosts', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(301, 'https://sub.hbcubandhub.tech/api/bands');
      expect(mockNext).not.toHaveBeenCalled();
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle root path', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(301, 'https://hbcubandhub.tech/');
      expect(mockNext).not.toHaveBeenCalled();
    });
    ...
    it('should handle paths with special characters', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(
        301,
        'https://api.hbcubandhub.tech/api/bands/search?name=Test%20Band&city=New%20York'
      );
      expect(mockNext).not.toHaveBeenCalled();
    });
    ...
    it('should handle paths with hash fragments', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(301, 'https://hbcubandhub.tech/api/docs#section-1');
      expect(mockNext).not.toHaveBeenCalled();
    });
  ...
  describe('Logging Behavior', () => {
    ...
    it('should log when LOG_HTTPS_REDIRECTS is enabled', () => {
      ...
      expect(mockResponse.redirect).toHaveBeenCalledWith(301, 'https://api.hbcubandhub.tech/api/bands');
    });
